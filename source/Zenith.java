...
public class Zenith extends PApplet {
...
*/
 ...
 //Sound library to play theme song.
SoundFile song;
...
public void setup() {
   //final resolution of 256 x 192 pixels, graphics inspired by the ZX-81
...
public void display_img(int image_number) {
  /*
  ...
  */
  imageMode( CENTER ); 
  int img_height = PApplet.parseInt(196 / 2 * res); //new image dimensions
...
public void player_choice (String option_one, int outcome_one, String option_two, int outcome_two) {
  /*
...
public void position_prompt (String prompt) {
  /*
...
public void game_positions() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#000000", "--stop-color=#cccccc", "Zenith" };
    if (passedArgs != null) {
